              ...
              <div className="row">
                ...
                <div className="col-md-6 col-sm-12 col-12 login-main-right">
                  <form className="login-form reg-form">
                    ...
                    <div className="input-div one">
                      <div className="div lg-lable">
                        <h5>Tên người liên hệ<span className="req">*</span></h5>
                        <input type="text" className="input form-control-lgin" />
                      </div>
                    </div>
                    <div className="input-div one">
                      <div className="div lg-lable">
                        <h5>Số điện thoại liên hệ<span className="req">*</span></h5>
                        <input type="text" className="input form-control-lgin" />
                      </div>
                    </div>
                    <div className="input-div one">
                      <div className="div lg-lable">
                        <h5>Tên công ty<span className="req">*</span></h5>
                        <input type="text" className="input form-control-lgin" />
                      </div>
                    </div>
                    <div className="input-div one">
                      <div className="div lg-lable">
                        <h5>Địa Chỉ Công Ty<span className="req">*</span></h5>
                        <input type="text" className="input form-control-lgin" />
                      </div>
                    </div>
                    <div className="input-div one">
                      <div className="div lg-lable">
                        <h5>Thành phố<span className="req">*</span></h5>
                        <input type="text" className="input form-control-lgin" />
                      </div>
                    </div>
