                ...
                <div className="job-board-wrap">
                  <div className="job-group">
                    {news.job?.map((item: any) => {
                      return (
                        <div className="job pagi" key={item.id}>
                          <div className="job-content">
                            <div className="job-logo">
                              <a href="#">
                                <img
                                  src="img/luxoft-vietnam-logo.png"
