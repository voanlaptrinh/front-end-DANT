                                ...
                                <div className="col-md-7 col-sm-12 col-12" >
                                    <div className="job-detail-header-desc">
                                        ...
                                        <div className="job-detail-header-de">
                                            <ul>
                                                <li><i className="fa fa-map-marker icn-jd" /><span>Đà Nẵng</span></li>
                                                <li><i className="fa fa-usd icn-jd" /><span>15 triệu - 20 triệu</span></li>
                                                <li><i className="fa fa-calendar icn-jd" /><span>15/01/2019</span></li>
                                            </ul>
                                        </div>
                                    ...
                                    <div className="welfare-wrap">
                                        <div className="row">
                                            <div className="welfare-list">
                                                <ul>
                                                    <li>
                                                        <p><i className="fa fa-usd icn-welfare" />Have opponunity for growth.</p>
                                                    </li>
                                                    <li>
                                                        <p><i className="fa fa-user icn-welfare" />Working under energisitic, innovative, friendly environment.</p>
                                                    </li>
                                                    <li>
                                                        <p><i className="fa fa-check-circle icn-welfare" />Competitive salary and attractive benefits packages.</p>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
